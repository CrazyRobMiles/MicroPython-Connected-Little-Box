...
class Manager(CLBDeviceManager):
    ...
    def get_interface(self):
        return {
            "set_position": ("Set servo position (0..1): set_position(channel, position)", self.command_set_position),
            "set_position_name": ("Set named servo position (0..1): set_position_name(name, position)", self.command_set_position_name),
            "set_degrees": ("Set servo angle in degrees: set_degrees(channel, degrees)", self.command_set_degrees),
            "set_degrees_name": ("Set named servo angle in degrees: set_degrees_name(name, degrees)", self.command_set_degrees_name),
            "reset": ("Reset servo to default position: reset(channel)", self.command_reset),
            "reset_name": ("Reset named servo to default: reset_name(name)", self.command_reset_name),
            "reset_all": ("Reset all servos to default", self.command_reset_all),
            "off": ("Turn off servo: off(channel)", self.command_off),
            "off_name": ("Turn off named servo: off_name(name)", self.command_off_name),
            "off_all": ("Turn off all servos", self.command_off_all),
            "list": ("List all configured servos", self.command_list),
            "info": ("Show servo info: info(channel_or_name)", self.command_info),
            "capture_start": ("Start position capture: capture_start(channel)", self.command_capture_start),
            "capture_reset": ("Reset captured position: capture_reset(channel)", self.command_capture_reset),
            "capture_stop": ("Stop position capture: capture_stop(channel)", self.command_capture_stop),
            "capture_start_name": ("Start position capture by name: capture_start_name(name)", self.command_capture_start_name),
            "capture_reset_name": ("Reset captured position by name: capture_reset_name(name)", self.command_capture_reset_name),
            "capture_stop_name": ("Stop position capture by name: capture_stop_name(name)", self.command_capture_stop_name),
            "set_start": ("Set servo start angle: set_start(channel, degrees)", self.command_set_start),
            "set_reset": ("Set servo reset angle: set_reset(channel, degrees)", self.command_set_reset),
            "set_stop": ("Set servo stop angle: set_stop(channel, degrees)", self.command_set_stop),
            "set_start_name": ("Set named servo start angle: set_start_name(name, degrees)", self.command_set_start_name),
            "set_reset_name": ("Set named servo reset angle: set_reset_name(name, degrees)", self.command_set_reset_name),
            "set_stop_name": ("Set named servo stop angle: set_stop_name(name, degrees)", self.command_set_stop_name),
            "run": ("Run servo orchestration: run(orchestration_dict)", self.command_run),
            "run_named": ("Run named orchestration: run_named(name)", self.command_run_named),
            "stop": ("Stop orchestration by ID: stop(run_id)", self.command_stop),
            "stop_name": ("Stop named orchestration: stop_name(name)", self.command_stop_name),
            "stop_all": ("Stop all running orchestrations", self.command_stop_all),
            "running": ("List all running orchestrations", self.command_running),
        }
