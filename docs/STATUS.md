...
- work in progress
### SX70-R manager
- working, needs proper testing for use with WiFi active
- need to test for multiple camera devices
### GPIO manager
- working, needs more detailed documentation for event creation and management
### Rotary encoder
-- working
